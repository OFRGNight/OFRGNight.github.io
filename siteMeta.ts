  ...
  services: [
    {
      ...
      icon: "/images/icons/services/oil.svg",
    },
    {
      name: "Carga em bateria",
      description: "De forma segura!",
      icon: "/images/icons/services/battery.svg",
    },
    {
      name: "Injeção Eletrônica",
      description: "Nacionais e importados.",
      icon: "/images/icons/services/electronic.svg",
    },
    {
      name: "Revisão",
      description: "Em qualquer veículo.",
      icon: "/images/icons/services/revision.svg",
    },
    {
      name: "E muito mais",
      description: "Entre em contato.",
      icon: "/images/icons/services/more.svg",
    },
  ],
  team: [
    {
    ...
    //   name: "Victor",
    //   role: "Mecânico",
    //   image: "/images/team/Victor.webp",
    // },
    // {
    //   name: "Octávio",
    //   role: "Aprendiz",
    //   image: "/images/team/Octavio.webp",
    // },
    {
      name: "Murillo",
      role: "Aprendiz",
      image: "/images/team/Murillo.webp",
    },
  ],
};
